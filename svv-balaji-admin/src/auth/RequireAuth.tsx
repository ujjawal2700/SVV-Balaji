 ...
 * a second front end.
 *
 * The definition now lives in `shared/auth/RequireAuth.tsx` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/auth/RequireAuth` directly. This shim can go once
