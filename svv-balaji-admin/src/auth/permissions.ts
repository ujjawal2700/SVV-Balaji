 ...
 * a second front end.
 *
 * The definition now lives in `shared/auth/permissions.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/auth/permissions` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/auth/permissions';
