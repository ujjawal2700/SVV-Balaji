 ...
 * a second front end.
 *
 * The definition now lives in `shared/components/pickers.tsx` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/components/pickers` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/components/pickers';
