 ...
 * a second front end.
 *
 * The definition now lives in `shared/components/Sheet.tsx` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/components/Sheet` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/components/Sheet';
