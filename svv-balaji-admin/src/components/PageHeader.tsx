 ...
 * a second front end.
 *
 * The definition now lives in `shared/components/PageHeader.tsx` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/components/PageHeader` directly. This shim can go once
