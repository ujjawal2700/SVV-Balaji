 ...
 * a second front end.
 *
 * The definition now lives in `shared/utils/format.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/utils/format` directly. This shim can go once
