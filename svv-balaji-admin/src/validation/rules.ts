 ...
 * a second front end.
 *
 * The definition now lives in `shared/validation/rules.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/validation/rules` directly. This shim can go once
