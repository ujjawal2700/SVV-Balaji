 ...
 * a second front end.
 *
 * The definition now lives in `shared/api/uploads.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/api/uploads` directly. This shim can go once
