 ...
 * a second front end.
 *
 * The definition now lives in `shared/api/production.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/api/production` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/api/production';
