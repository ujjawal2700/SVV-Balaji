 ...
 * a second front end.
 *
 * The definition now lives in `shared/api/branches.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/api/branches` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/api/branches';
