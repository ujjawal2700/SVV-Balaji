 ...
 * a second front end.
 *
 * The definition now lives in `shared/api/client.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/api/client` directly. This shim can go once
