 ...
 * a second front end.
 *
 * The definition now lives in `shared/api/quality.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/api/quality` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/api/quality';
