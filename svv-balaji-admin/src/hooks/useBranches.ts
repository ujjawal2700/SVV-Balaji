 ...
 * a second front end.
 *
 * The definition now lives in `shared/hooks/useBranches.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/hooks/useBranches` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/hooks/useBranches';
