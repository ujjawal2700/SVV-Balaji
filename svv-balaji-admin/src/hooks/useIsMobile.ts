 ...
 * a second front end.
 *
 * The definition now lives in `shared/hooks/useIsMobile.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/hooks/useIsMobile` directly. This shim can go once
