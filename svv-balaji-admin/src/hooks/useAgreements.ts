 ...
 * a second front end.
 *
 * The definition now lives in `shared/hooks/useAgreements.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/hooks/useAgreements` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/hooks/useAgreements';
