 ...
 * a second front end.
 *
 * The definition now lives in `shared/hooks/useProcurement.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/hooks/useProcurement` directly. This shim can go once
 * nothing references it.
 */
export * from '../../../shared/hooks/useProcurement';
