 ...
 * a second front end.
 *
 * The definition now lives in `shared/config.ts` and is compiled into both apps, so the
 ...
 * in one commit.
 *
 * New code should import from `@shared/config` directly. This shim can go once
